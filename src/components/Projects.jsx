    ...
    return (
        <div id='projects' className=' p-[3rem] py-[3rem] mt-10 sm:mt-0 sm:px-[1.25rem] sm:py-[-15px] '>
            ...
            <div className='flex gap-5 mt-8 tm:flex-col-reverse tm:items-center sm:flex-col-reverse'>
                ...
                <Fade right>
                    <img src={rent} className="rounded-[10px] w-[40%] tm:w-[100%] tm:mb-10 sm:w-[100%]" />
                </Fade>
            </div>

            <div className='flex gap-5 mt-14 mb-14 tm:flex-col tm:items-center sm:flex-col'>
                <Fade left>
                    <img src={royal} className="rounded-[10px] w-[40%] tm:w-[100%] tm:mb-10 sm:w-[100%]" />
                </Fade>
                <Fade right>
                    <div className='relative w-[60%] flex justify-center items-center  sm:w-[100%]'>
                        <div className='  gap-2   flex flex-col '>
                            ...
                            <p className='w-[500px]  font-[350] text-[1rem] leading-loose sm:text-[.9rem]  tm:text-[1rem] md:w-[100%] sm:w-[100%]'>Created a user-friendly platform that enables users to book tailors online. The website features a modern and responsive design, with a simple and intuitive user interface that makes booking tailors easy.</p>
                            <div className='flex gap-5 mt-7'>
            ...
            <div className='flex gap-5 mt-8 tm:flex-col-reverse tm:items-center sm:flex-col-reverse'>
                <Fade left>
                    <div className='relative w-[60%] flex justify-between items-center tm:justify-center sm:justify-start tm:w-[100%] sm:w-[100%]'>
                        ...
                        <div className=' gap-2 flex flex-col '>
                            ...
                            <p className='w-[500px]  font-[350] text-[1rem] leading-loose sm:text-[.9rem]  tm:text-[1rem] md:w-[100%] sm:w-[100%] '>I created a user-friendly platform that enables users to easily book a travel car with a guide. The website features a modern and responsive design, with a simple and intuitive user interface that makes booking travel agent easy.</p>
                            <div className='flex gap-5 mt-7'>
                ...
                <Fade right>
                    <img src={natick} className="rounded-[10px] w-[40%] tm:w-[100%] tm:mb-10 sm:w-[100%]" />
                </Fade>
            </div>
            ...
            <div className='flex gap-5 mt-20 tm:flex-col tm:items-center sm:flex-col'>
                <Fade left>
                    <img src={etest} className="rounded-[10px] w-[40%] tm:w-[100%] tm:mb-10 sm:w-[100%]" />
                </Fade>
                <Fade right>
                    <div className='relative w-[60%] flex justify-center items-center  sm:w-[100%]'>
                        <div className='  gap-2   flex flex-col '>
                            <h1 className='text-[1.3rem] mb-2 sm:text-[1rem] '>E-Testing Service </h1>
                            <p className='w-[500px]  font-[350] text-[1rem] leading-loose sm:text-[.9rem]  tm:text-[1rem] md:w-[100%] sm:w-[100%]'>I created a Learning Management System (LMS) that features real-time notification, natural language processing (NLP) question generation and checking, and voice-to-text answering. The website is designed to facilitate online testing and evaluation for students and educators.</p>
                            <div className='flex gap-5 mt-7'>
