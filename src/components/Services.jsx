...
function Services() {
    ...
    return (
        <div id="about" className="sm:flex sm:flex-col-reverse  ">
            <div ref={ref} >
                <Fade bottom>
                    <div className='mb-20 px-[3em] mt-[3.3em] flex justify-between mx-[3.5em] flex-wrap  text-white rounded-xl bg-yellow-500 min-h-[10rem] lg:px-[2em] md:mt:[5rem] md:gap-y-1 tm:px-[1em] sm:mt-[1em] sm:px-[0.5em]  sm:mx-[1.4em] sm:mb-2'>
            ...
            <div className='flex flex-col justify-between p-[4rem] py-[1rem] tm:flex-col sm:flex-col sm:px-[1.5rem] tm:py-[0rem] sm:py-5'>
                <Fade left>
                    <h1 className=' mb-10 tracking-wider font-[600] text-[2rem] lg:text-[2rem] md:text-[2rem] tm:text-[2.5rem] tm:mb-2  tm:w-[40rem] sm:text-[1.8rem] sm:mb-4 sm:w-[100%]'>What Can I Do For Your Needs ?</h1>
                </Fade>
                <Fade right>
