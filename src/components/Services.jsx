...
function Services() {
    ...
    return (
        <div id="about" className="sm:flex sm:flex-col-reverse  ">
            <div ref={ref} >
                <Fade bottom>
                    <div className='mb-20 sm:py-[10px] tm:py-[20px] px-[2em] py-[35px] mt-[3.3em] flex justify-between mx-[3.5em] flex-wrap  text-white rounded-xl bg-yellow-500 min-h-[10rem] lg:px-[2em] md:mt:[5rem] md:gap-y-1 tm:px-[1em] sm:mt-[1em] sm:px-[0.5em]  sm:mx-[1.4em] sm:mb-2'>
            ...
            <div className='flex flex-col justify-between px-[4rem] pt-[5rem] pb-[7rem] tm:flex-col sm:flex-col sm:px-[1.5rem] tm:py-[0rem] sm:py-5'>
                <Fade bottom>
