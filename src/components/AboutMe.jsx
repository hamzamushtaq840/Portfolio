...
function AboutMe() {
    ...
    return (
        <div className='flex mt-10 pl-[4rem] lg:mt-0 lg:pt-0 pr-[2rem] py-[2rem] justify-between md:mt-0 md:pt-0 tm:flex-col sm:flex-col  sm:px-[1.5rem] sm:mt-0'>
            <Fade left>
                <div className='flex flex-col mt-[5rem] pt-6 item-center w-[70%] min-h-[58vh] tm:min-h-min tm:w-full tm:mt-[.5rem] sm:min-h-min sm:w-full sm:mt-[.5rem] sm:pt-0 tm:pt-0'>
            ...
            <div className='flex justify-end pr-10 sm:justify-between sm:pr-0 sm:flex-col'>
                <Fade bottom>
                    <Tilt className="box" options={options} >
                        <div className='h-full mr-5 pt-10 justify-end  flex items-center sm:mr-0 sm:justify-center'>
