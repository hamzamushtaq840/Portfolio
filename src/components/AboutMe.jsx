...
function AboutMe() {
    ...
    return (
        <div className='flex sm:min-h-0 min-h-[calc(100vh-6.4rem)] items-center   pl-[4rem] lg:mt-0 lg:pt-0 pr-[1rem] py-[0rem] md:mt-0 md:pt-0 tm:flex-col sm:flex-col  sm:px-[1.5rem] sm:mt-0'>
            <div className='flex sm:mt-[10px] tm:mt-[40px] mt-[-30px] md:mt-0 xsm:mt-0 flex-col pt-0 justify-center w-[70%] min-h-[58vh] tm:min-h-min tm:w-full sm:min-h-min sm:w-full  sm:pt-0 tm:pt-0'>
                ...
                <div>
                    <Typed
                        className='font-[500] dark:font-[400] text-black dark:text-[#efdf32] text-[1.3rem] mb-2 sm:text-[1rem]'
                ...
                <br />
                <p className='dark:text-[#ccc] leading-loose font-[400] mt-[-.8rem] text-custom-18  sm:text-[.8rem] w-[90%] lg:w-[70%] md:w-[95%] tm:w-full sm:w-full sm:mt-0'>I'm a MERN developer experienced in frontend and backend technologies. My tech stack includes ReactJS
                    NodeJS, Express,
                    JavaScript,
                    TypeScript,
                    SQL Databases,
                    NoSQL Databases,
                    NextJS and
                    Web Scrapping. I build efficient web applications from designing interfaces to implementing server-side logic.</p>
            </div>

            <div className='flex py-[10px] tm:mt-[40px] items-start pr-10 mt-[-30px] tm:pr-0 sm:pr-0 sm:justify-between sm:flex-col'>
                ...
                <div className='flex sm:w-full  items-center gap-4 flex-col mt-[0] justify-center pt-[35%] sm:flex-row sm:pt-5'>
